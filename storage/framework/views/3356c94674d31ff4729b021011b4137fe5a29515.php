        ...
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                <li class="<?php echo e(\Request::route()->getName() == 'admin.home' ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('admin.home')); ?>">Trang Tổng Quan <span class="sr-only">(current)</span></a>
                </li>
                <li class="<?php echo e(\Request::route()->getName() == 'admin.get.list.category' ? 'active' : ''); ?>"><a href="<?php echo e(route('admin.get.list.category')); ?>">Danh mục</a></li>
                <li class="<?php echo e(\Request::route()->getName() == 'admin.get.list.product' ? 'active' : ''); ?>"><a href="<?php echo e(route('admin.get.list.product')); ?>">Sản phẩm</a></li>
                <li class="<?php echo e(\Request::route()->getName() == 'admin.get.list.article' ? 'active' : ''); ?>"><a href="<?php echo e(route('admin.get.list.article')); ?>">Tin Tức</a></li>
...
<script src="<?php echo e(asset('theme_admin/js/jquery.min.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\Learn_PHP_FPT\MyTodoList\Modules/Admin\Resources/views/layouts/master.blade.php ENDPATH**/ ?>